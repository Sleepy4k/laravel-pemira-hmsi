<x-layout.dashboard title="Candidates">
    ...
    <form id="create-candidate-form" data-method="POST" action="#" enctype="multipart/form-data" data-redirect="{{ route('dashboard.candidates.index') }}"
        class="grid grid-cols-4 gap-8 w-full bg-white p-6 rounded-lg shadow-md" data-action="{{ route('dashboard.candidates.store') }}">
        @csrf
